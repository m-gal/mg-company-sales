...
# [X]TODO: Baseline model
# [X]TODO: [128, 512, 1024] units
# [X]TODO: Try loss = mae
# TODO: Check how including of "naics_code" influences
# [X]TODO: OHE for addr_state, addr_city
# [X]TODO: Business spec as free text w/o vocab
...
from src.dl.models import base_model
...
MODEL_PARAMS = {
    "_batch_size": 130_944,
    "_epochs": 25,
    "_optimizer": tf.keras.optimizers.RMSprop(learning_rate=0.002),
...
CATEGORICAL_STRING_FEATURES_TO_OHE = ["company_employees"]
...
inputs, _, _, flattened_features = create_model_inputs_and_features(
    set_of_features,
    ds_train,
    embedding_dims=None,
    print_result=True,
